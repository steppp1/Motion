...
const rulesRegister = {
  ...
  phone: [
    ...
    { pattern: /^(\+?\d{1,3}[- ]?)?\d{11}$/, message: '电话号码格式不正确！', trigger: 'blur' }
],
  username: [
      ...
      <div class="rightArea" v-if="!showWhich">
        ...
        <div class="form">
          <el-form ref="formRegisterRef" :model="formRegister" :rules="rulesRegister" label-position="right"
            ...
            <el-form-item prop="phone" class="inputArea"> <!-- 添加电话号码输入框 -->
              <el-input class="my" v-model="formRegister.phone" placeholder="请输入电话号码" :prefix-icon="ChatLineSquare"/>
            </el-form-item>
